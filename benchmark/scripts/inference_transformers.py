...
def main(args):
    ...
    tokenizer = tokenizer_class.from_pretrained(
        args.model_id, do_lower_case=False, legacy=False
    )
        ...
        for sequence_length in sequence_lengths:
            ...
            if args.is_neuron:
                ...
                if "inf1" in instance_type:
                    print(
                        f"Compiling model for seq length {sequence_length} and batch size {batch_size}..."
                    )
            ...
            if args.is_neuron:
                ...
                res = measure_latency(
                    model, tokenizer, sequence_length, batch_size, args.is_neuron
                )
